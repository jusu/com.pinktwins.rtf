...
/**
 * <b>RTFParser</b> is a subclass of <b>AbstractFilter</b> which understands basic RTF syntax and passes a stream of
 * control words, text, and begin/end group indications to its subclass.
 * 
 * Normally programmers will only use <b>RTFFilter</b>, a subclass of this class that knows what to do with the tokens
 * this class parses.
 * 
 * @see AbstractFilter
 * @see RTFFilter
...
abstract class RTFParser extends AbstractFilter {
	...
	/**
	 * A stream to which to write warnings and debugging information while parsing. This is set to
	 * <code>System.out</code> to log any anomalous information to stdout.
	 */
	...
	/**
	 * Implemented by subclasses to interpret a parameter-less RTF keyword. The keyword is passed without the leading
	 * '/' or any delimiting whitespace.
	 */
	...
	/**
	 * Flushes any buffered but not yet written characters. Subclasses which override this method should call this
	 * method <em>before</em> flushing any of their own buffers.
	 */
	...
	/**
	 * Closes the parser. Currently, this simply does a <code>flush()</code>, followed by some minimal consistency
	 * checks.
	 */
